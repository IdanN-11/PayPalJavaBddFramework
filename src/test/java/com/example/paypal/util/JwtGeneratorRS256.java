...
public class JwtGeneratorRS256 {
  ...
  public static String generateJwt() throws NoSuchAlgorithmException, InvalidKeySpecException {
    // String key=
    // "ENVjN3YH3NYAlNc8PHDXMeNASsicoCwE8IaHADhrCnfPjQNx-cM7WOAJypAc3MqQ4FzVur6JxlAwnH3g";//secretkey
    ...
    // claims.put("sub",
    // "AZCJEFUh23ILAks14wm32o4f5jiyDrbqhSrNVc6bUcbOtYDFXvJplsZaYmf-Ig3tGCzEe3thxF3gmpy2");
